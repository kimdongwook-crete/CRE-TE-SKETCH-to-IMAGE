...
export const MODEL_IMAGE_REFINE = 'gemini-exp-1206'; // Step 3: High-Fidelity Refinement (Imagen 4 Ultra Equivalent)
export const TIMEOUT_DURATION = 60000; // 60 Seconds
