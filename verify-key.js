...
// 2. Test Call to Gemini API (gemini-3-flash-preview)
const model = 'models/gemini-3-flash-preview'; // Analysis Model
// Note: image-preview might behave differently, but testing one confirms connectivity.
...
const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
        if (res.statusCode === 200) {
            ...
            console.log("Model responded (200 OK).");
        } else {
